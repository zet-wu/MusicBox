...
import type {FolderSourcesPage} from '@ui/pages/FolderSourcesPage';
...
import type {FolderPlaylistBindingDialog} from '@ui/dialogs/FolderPlaylistBindingDialog';
import type {PlaylistBindingDialog} from '@ui/dialogs/PlaylistBindingDialog';
...
export interface ComponentRegistryMap {
    ...
    folderPlaylistBindingDialog: FolderPlaylistBindingDialog;
    ...
    homePage: HomePage;
    folderSourcesPage: FolderSourcesPage;
